    ...
    const QUESTIONS = [
      {
        ...
        dimension: "progress",
        weight: 2,
        text: "По логике тренинга, наш самый главный конкурент — это…",
        options: [
        ...
        review: {
          strong: "Ключевая мысль тренинга: чаще всего мы конкурируем не с другим продавцом, а с отсутствием необходимости что-то менять.",
          bullets: [
      ...
      },
      {
        ...
        dimension: "prep",
        weight: 2,
        text: "Какой вывод делает тренинг из тезиса «того, что мы узнаем от клиента, недостаточно»?",
        options: [
      ...
      },
      {
        ...
        dimension: "assertive",
        weight: 2,
        text: "Какие формулировки в логике тренинга можно считать скорее агрессивными? Выбери все подходящие варианты.",
        options: [
      ...
      },
      {
        ...
        dimension: "value",
        weight: 2,
        text: "Что означает «конструктивное напряжение» в логике этого тренинга?",
        options: [
      ...
      },
      {
        ...
        dimension: "value",
        weight: 2,
        text: "Какие факторы из исследования Marketing Leadership Council в презентации названы особенно важными для лояльности? Выбери все подходящие варианты.",
        options: [
      ...
      },
      {
        ...
        review: {
          strong: "В презентации самая большая доля отдана именно процессу продажи — 53%. Это центральный аргумент в пользу качества самой встречи и взаимодействия.",
          bullets: [
      ...
      },
      {
        ...
        dimension: "value",
        weight: 3,
        text: "Объясни своими словами формулу из презентации: «Экспертиза → отношения → бизнес».",
        openRubric: {
          maxPoints: 8,
          groups: [
      ...
      },
      {
        ...
        dimension: "prep",
        weight: 2,
        text: "Какие выводы о неформальности и первой встрече делает тренинг? Выбери все подходящие варианты.",
        options: [
      ...
      app.innerHTML = `
        <section class="result-grid">
          ...
          <div class="result-card">
            ...
            <p>Тест не просто проверяет запоминание слайдов. Он показывает, насколько твоя логика встречи совпадает с логикой тренинга: подготовка, деловые гипотезы, ассертивность, создание ценности и качество процесса продажи.</p>
          </div>
        </section>
          ...
          <div class="dim-list">
            ${results.dimensionEntries.map(dim => `
              <div class="dim-card">
                ...
                ` : `
                  <ul class="dim-next">
                    <li>Эта часть у тебя уже опирается на логику тренинга. Сохраняй её и делай более конкретной в реальных встречах.</li>
                  </ul>
                `}
              </div>
            `).join("")}
    ...
    function getLevel(percent) {
      if (percent >= 85) {
        return {
          ...
          text: "У тебя хорошо читается логика тренинга: ты не сводишь встречу к сбору информации и не уходишь в давление. Следующий шаг — ещё больше конкретики в цифрах, гипотезах и формулировках."
        };
      }
      if (percent >= 65) {
        return {
      ...
      return {
        ...
        text: "Сейчас ответы больше похожи на реактивный разговор или на попытку понравиться. Стоит заново пройтись по идеям тренинга: status quo, гипотезы, ассертивность и ценность процесса продажи."
      };
    }
